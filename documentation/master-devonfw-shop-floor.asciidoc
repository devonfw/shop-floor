...
include::dsf-openshift-services-selenium-basic-grid.asciidoc[leveloffset=3]

=== Mirabaud Experience

include::dsf-mirabaud-cicd-environment-setup.asciidoc[leveloffset=3]
...
include::dsf-azure-install-sonar-with-docker-in-a-virtual-machine.asciidoc[leveloffset=2]

include::dsf-azure-pipelines.asciidoc[leveloffset=2]

include::dsf-azure-connection-strings.asciidoc[leveloffset=2]

include::dsf-azure-sonarqube-integration.asciidoc[leveloffset=2]

include::dsf-custom-plugin-for-sonar-AzureDevops.asciidoc[leveloffset=2]

=== OKD (OpenShift Origin)

include::dsf-okd.asciidoc[leveloffset=2]

include::dsf-okd.asciidoc[leveloffset=3]
...
include::dsf-istio-guide.asciidoc[leveloffset=3]