...
Here you can find all that you need to know to do your link:dsf-configuration-jenkinsfile.asciidoc[Jenkinsfile].

////
TODO:
==== Dockerfile

Here you can find all that you need to know to do your link:dsf-configuration-dockerfile.asciidoc[Dockerfile].
