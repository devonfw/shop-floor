...
Add link:dsf-configure-jenkins.asciidoc#create-docker-image[create docker image] stage.

Add link:dsf-configure-jenkins.asciidoc#deploy-docker-image[deploy docker image] stage.

Add link:dsf-configure-jenkins.asciidoc#check-status[check status] stage.

Upgrade link:dsf-configure-jenkins.asciidoc#setup-Jenkins-tools[Setup Jenkins tools] stage.
