...
Persisten Volumes can be easely created folling the the link:dsf-openshift-services-bitbucket-extra-server-configuration.asciidoc[BitBucket Extra server configuration]