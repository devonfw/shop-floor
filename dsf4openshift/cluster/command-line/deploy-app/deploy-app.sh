...
usage()
{
	...
	echo ""
	echo "This script try to create a project (if the proyect exist, don't worry it's not overwritten) and then, deploy an app with the params inside a file in that project. If the proyect need sshkey, a sshkey file could be used."
    echo ""
	echo "Usage:"
