...
oc create -f https://raw.githubusercontent.com/devonfw/devonfw-shop-floor/master/s2i/angular/s2i-devonfw-angular-imagestream.json?token=AT5D70BJUDSnlQ1uepFsl6wG1sLDN5lqks5aGBi6wA%3D%3D --namespace=devonfw
