...
oc secrets new-sshauth repo-at-github --ssh-privatekey=repo-at-github --namespace=devonfw
...
oc new-app --template=devonfw-angular-sample --namespace=devonfw --param-file=openshift.env
...
oc start-build devportal-angular --namespace=devonfw