...
NOTE: this is a copy of the original [`jenkins/ssh-slave` git repository](https://github.com/jenkinsci/docker-ssh-slave). We only add sudo to the installed packages and give sudo rights to Jenkins user.
